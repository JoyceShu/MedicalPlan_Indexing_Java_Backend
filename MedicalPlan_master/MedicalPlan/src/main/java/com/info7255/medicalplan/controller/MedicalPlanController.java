...
public class MedicalPlanController {
    ...
    public ResponseEntity<Object> deleteMedicalPlan(@RequestHeader HttpHeaders headers, @PathVariable String objectId) {
       ...
       // messageQueueService.publish(objectId,);
    ...
    public ResponseEntity<?> updatePlan(@PathVariable String objectId,
                                        @RequestBody(required = false) String medicalPlan,
...
//        }
        ...
        outputMap = medicalPlanService.getDeletePlan(redisKey, outputMap, false);

        String newEtag = medicalPlanService.saveMedicalPlan(planObject, redisKey);
